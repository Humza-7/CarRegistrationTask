export const carMakesData = ['Toyota', 'Honda', 'Ford', 'Chevrolet', 'Tesla'] // dummy data for the drop down of makers of the car

export const carModelsData = { // dummy data for the drop down of models of the car
...
export const registerCarsData = [ //registered cars dummy data
